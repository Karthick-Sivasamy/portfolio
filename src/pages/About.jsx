      ...
      <div className="h-full  w-full bg-[#f5f5f7] grid place-items-center">
        <div className="w-full flex flex-col lg:flex-row lg:items-center  justify-center lg:justify-between gap-6  md:gap-12 lg:gap-20 p-4 md:p-12 lg:p-24  ">
          ...
          <div className="text-lg md:text-xl flex-grow-1 font-medium flex flex-col gap-4">
            <p>
              Hi, I'm Karthick Sivasamy, a full-stack developer with over 1
              years of experience. I'm passionate about building web
              applications that solve real-world problems. I'm proficient in a
              variety of programming languages and frameworks, including
              JavaScript, React, Node.js, and Python. I'm also an expert in SQL
              and NoSQL databases.
            </p>
            <p>
